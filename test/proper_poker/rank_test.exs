defmodule ProperPoker.RankTest do
  ...
  describe "compare/1" do
    test "returns right when right win" do
    ...
    test "returns left when left win" do
    ...
    test "returns tie when no one win" do
    ...
    test "returns right when right win with score" do
    ...
    test "returns left when left win with score" do
      left_rank = {:ok, HighCard, 12}
      right_rank = {:ok, HighCard, 9}
    ...
    test "returns tie when score on both side are the same" do
      left_rank = {:ok, HighCard, 9}
      right_rank = {:ok, HighCard, 9}
